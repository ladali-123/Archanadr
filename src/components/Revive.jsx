...
export default function ReviewCarousel() {
  ...
  return (
    <div className="w-full bg-[#FAF6FB] pt-1 pb-10 sm:pt-2 sm:pb-12 px-4 sm:px-8 lg:px-16">
      <div
        ...
        >
          <div className="flex flex-col md:flex-row items-center md:items-stretch gap-8 md:gap-12">
            ...
            <div className="relative flex-1 md:min-h-[220px] flex flex-col justify-start md:justify-center px-2 sm:px-4 md:pl-4 pt-6 sm:pt-0">
              <Quote
                className="absolute top-2 sm:top-4 left-0 w-10 h-10 sm:w-12 sm:h-12 text-[#E5D6EC] rotate-180"
                strokeWidth={0}
                fill="currentColor"
              />
              <div
              ...
              >
                <p
                  className="font-serif italic text-[#2B1435] text-base sm:text-lg lg:text-lg
                ...
                >
                  – {review.name}{" "}
                  <span className="font-normal text-[#6b5470]">
                    ({review.context})
                  </span>
                </p>
              </div>
            ...
            <div className="flex items-center justify-center md:w-72 shrink-0">
              ...
              flex flex-col items-center justify-center text-center border border-[#F0E4F5]">
                <div className="flex items-start justify-center">
                  <span className="bg-gradient-to-r from-[#4a1263] to-[#c9a227] bg-clip-text text-transparent font-extrabold text-3xl sm:text-4xl tracking-tight">
                    {count.toLocaleString()}
                  </span>
                  <span className="bg-gradient-to-r from-[#4a1263] to-[#c9a227] bg-clip-text text-transparent font-extrabold text-2xl sm:text-3xl leading-none
                   mt-1">
                    +
                  </span>
                </div>
                <span className="mt-3 text-[#2B1435] text-base sm:text-lg font-medium">
                  Patients Treated
                </span>
              </div>
            </div>
          ...
          <button
            ...
            onClick={prev}
            className="hidden sm:flex absolute left-[-3rem] lg:left-[-3.5rem] top-1/2 -translate-y-1/2 w-10 h-10 items-center justify-center rounded-full bg-white hover:bg-[#F3EAF7] shadow text-[#4a1263] transition focus:outline-none focus-visible:ring-2 focus-visible:ring-[#4a1263]"
          >
          ...
          <button
            ...
            onClick={next}
            className="hidden sm:flex absolute right-[-3rem] lg:right-[-3.5rem] top-1/2 -translate-y-1/2 w-10 h-10 items-center justify-center rounded-full bg-white hover:bg-[#F3EAF7] shadow text-[#4a1263] transition focus:outline-none focus-visible:ring-2 focus-visible:ring-[#4a1263]"
          >
        ...
        <div className="flex items-center justify-center gap-2 mt-4">
          {REVIEWS.map((_, i) => (
            <button
              ...
              onClick={() => goTo(i)}
              className={`h-2.5 rounded-full transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#4a1263] ${
                i === index
                  ? "w-7 bg-gradient-to-r from-[#4a1263] to-[#c9a227]"
                  : "w-2.5 bg-[#DCC7E4] hover:bg-[#C4A0D0]"
              }`}
            />
          ))}
        </div>
