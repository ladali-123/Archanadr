// apni image assets folder se import karo (jaisa aapke project me path ho)
    ...
    <section className="relative overflow-hidden bg-white px-6 py-12 md:px-12 md:py-16">
      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        <div className="mx-auto mb-8 max-w-3xl text-center md:mb-12">
          <h1 className="text-3xl font-bold leading-tight text-[#424242] sm:text-4xl md:text-5xl">
            Psychiatrist in <span className="text-[#424242]] italic">Patna, India</span>
          </h1>
        </div>
        ...
        <div className="flex flex-col items-stretch gap-12 md:flex-row md:justify-between md:gap-22">
          ...
          {/* ---- Right: About Us text ---- */}
          <div className="order-1 flex w-full flex-col items-center text-center md:order-2 md:w-1/2 md:items-start md:text-left">
            <span className="mb-4 inline-flex items-center gap-2 text-xs font-semibold tracking-widest text-blue-500">
              <span className="h-[2px] w-6 bg-blue-500" />
              ABOUT US
            </span>
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-4 md:justify-start">
              <button className="rounded-full bg-blue-500 px-8 py-3 text-sm font-semibold text-white shadow-lg 
              shadow-slate-900/10 transition hover:bg-blue-700">
                Contact Us
              </button>
            </div>
          </div>
