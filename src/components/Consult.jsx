...
export default function CtaSection() {
  return (
    ...
    >
      {/* Overlay */}
      <div className="absolute inset-0 bg-[#2b0a40]/60" />

      {/* Decorative Blur */}
      <div className="absolute -top-10 -right-10 w-40 h-40 bg-[#c9a227]/10 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="relative z-10 h-full max-w-7xl mx-auto px-5 sm:px-8 lg:px-16 flex flex-col md:flex-row items-center justify-between gap-6 md:gap-10 py-6 md:py-0">
        ...
        <div className="shrink-0">
          <Link
            to="/contact"
            className="group inline-flex items-center gap-2 bg-[#c9a227] hover:bg-[#e8c85a] text-[#2b0a40] font-semibold text-sm md:text-base px-5 md:px-6 py-3 rounded-full shadow-lg transition-all duration-300 hover:scale-105 whitespace-nowrap"
            style={{ fontFamily: "'Inter', sans-serif" }}
          >
            BOOK A CONSULTATION
            <ArrowRight
