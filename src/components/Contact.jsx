    ...
    <section className="relative bg-white py-16 px-6 md:px-10 lg:px-16 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-stretch">
          {/* LEFT: Form */}
          <div className="bg-white rounded-2xl border border-[#E7EBF1] shadow-[0_10px_30px_rgba(74,18,99,0.06)] p-7 md:p-9">
            {submitted ? (
              <div className="h-full flex flex-col items-center justify-center text-center py-16">
                ...
                <button
                  ...
                  className="mt-6 font-['Inter'] text-[13px] font-semibold text-[#4a1263] hover:underline"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button
                  type="submit"
                  className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-[#5a1a7a] via-[#4a1263] to-[#2b0a40] text-white font-['Inter'] font-semibold text-[15px] py-3.5 rounded-xl shadow-md hover:shadow-lg hover:-translate-y-0.5 transition-all"
                >
                  Book Consultation
          ...
          <div className="flex flex-col">
            <div className="relative rounded-2xl overflow-hidden shadow-[0_20px_45px_rgba(74,18,99,0.15)] border border-[#E7EBF1] flex-1 min-h-[280px]">
              {!imgError ? (
                <img
                  src={consult}
                ...
                <div className="w-full h-full min-h-[280px] bg-gradient-to-br from-[#2b0a40] to-[#4a1263] flex items-center justify-center">
            ...
            <div className="grid grid-cols-2 gap-4 mt-6">
              {CONTACT_INFO.map((info) => {
                ...
                return (
                  <div
                    key={info.label}
                    className="flex items-start gap-3 bg-[#F8F6FA] border border-[#E7EBF1] rounded-xl px-4 py-3.5"
                  >
                    <span className="flex-shrink-0 w-8 h-8 rounded-full bg-[#4a1263] flex items-center justify-center">
                      <Icon className="w-4 h-4 text-white" />
                    </span>
                    <div>
                      <p className="font-['Inter'] text-[11px] font-semibold text-[#4a1263] uppercase tracking-wide">
                        {info.label}
                      </p>
